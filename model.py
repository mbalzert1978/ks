...
class Customer(SQLModel, table=True):
    ...
    Email: str
    SupportRepId: int = Field(foreign_key="Employee.EmployeeId")
...
class Employee(SQLModel, table=True):
    ...
    ReportsTo: int = Field(foreign_key="Employee.EmployeeId")
...
class Invoice(SQLModel, table=True):
    ...
    CustomerId: int | None = Field(
        default=None, foreign_key="Customer.CustomerId"
    )
    InvoiceDate: date
    BillingAddress: str | None = Field(
        default=None,
    )
    BillingCity: str | None = Field(
        default=None,
    )
    BillingState: str | None = Field(
        default=None,
    )
    BillingCountry: str | None = Field(
        default=None,
    )
    BillingPostalCode: str | None = Field(
        default=None,
    )
    Total: str
...
class InvoiceLine(SQLModel, table=True):
    ...
    InvoiceId: int | None = Field(
        default=None, foreign_key="Invoice.InvoiceId"
    )
...
class Track(SQLModel, table=True):
    ...
    MediaTypeId: int | None = Field(
        default=None, foreign_key="MediaType.MediaTypeId"
    )
